...
public class WonderForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<WonderForestTrunkDecorator> CODEC = Codec.unit(WonderForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wonder_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
