...
package io.github.errordude42.sillywillycore.world.features.treedecorators;
...
public class WonderForestFruitDecorator extends CocoaDecorator {
	public static Codec<WonderForestFruitDecorator> CODEC = Codec.unit(WonderForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wonder_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public WonderForestFruitDecorator() {
		super(0.2f);
	}
